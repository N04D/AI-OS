...
| docs/environment.md | other | 3 | 0 | OK |
| docs/evaluation-and-commit-protocol-v0.1.md | other | 2 | 1 | HAS_MISSING_REFS |
...
| docs/phase-acceptance-rule.v0.1.md | other | 26 | 1 | HAS_MISSING_REFS |
| docs/phase-gate-governance-protocol-v0.1.md | other | 1 | 1 | HAS_MISSING_REFS |
| docs/phase-gate-multi-cycle-scheduler-v0.1.md | other | 1 | 0 | OK |
| docs/phase-gate-runtime-enforcement-v0.1.md | other | 3 | 1 | HAS_MISSING_REFS |
| docs/plugins-ops.md | other | 43 | 9 | HAS_MISSING_REFS |
| docs/plugins.md | other | 30 | 7 | HAS_MISSING_REFS |
| docs/pr-gate-path-allowlist.md | other | 26 | 4 | HAS_MISSING_REFS |
| docs/pre-execution-environment-validation-v0.1.md | other | 2 | 1 | HAS_MISSING_REFS |
...
| docs/specs/execution-permit-attestation-contract-v0.1.schema.json | schema | 0 | 0 | OK |
| docs/specs/policy-to-capability-deterministic-mapping-contract-v0.1.md | policy | 31 | 0 | OK |
| docs/specs/policy-to-capability-mapping-v0.1.schema.json | policy | 0 | 0 | OK |
| docs/specs/secure-execution-layer-v0.2-milestone-notes.md | spec | 0 | 0 | OK |
| docs/specs/self_improvement_proposal.v0.1.md | spec | 12 | 1 | HAS_MISSING_REFS |
| docs/specs/self_improvement_risk_tiers.v0.1.md | spec | 10 | 0 | OK |
| docs/specs/supervisor-execution-permit-issuance-flow-v0.1.md | spec | 28 | 3 | HAS_MISSING_REFS |
...
| governance/policy/plugin-manifest.v0.1.yaml | policy | 0 | 0 | OK |
| governance/policy/plugins/plugin-boundary.v0.1.yaml | policy | 0 | 0 | OK |
| governance/policy/pr-governance.v0.2.yaml | policy | 1 | 0 | OK |
| governance/policy/skills/skills.v0.1.yaml | policy | 0 | 0 | OK |
| governance/schema/plugins/plugin-manifest.v0.1.yaml | schema | 0 | 0 | OK |
| governance/schema/scheduler/job.v0.1.json | schema | 0 | 0 | OK |
